...
public class RandomNumberGenerator3 extends Worker {
    ...
    public RandomNumberGenerator3(@NonNull Context context, @NonNull WorkerParameters workerParams) {
        ...
        while (i < 5) {
            try {
                ...
                if (mIsRandomGenerationOn) {
                    ...
                    Log.e("check", "Worker 3: " + Thread.currentThread().getId() + "Random Number: " + mRandomNumber);
                    i++;
                }
